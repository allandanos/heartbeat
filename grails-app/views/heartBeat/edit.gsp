    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${heartBeatInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="coordinates"><g:message code="heartBeat.coordinates.label" default="Coordinates" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: heartBeatInstance, field: 'coordinates', 'errors')}">
...
<g:link controller="heartBeatCoordinate" action="create" params="['heartBeat.id': heartBeatInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'heartBeatCoordinate.label', default: 'HeartBeatCoordinate')])}</g:link>
