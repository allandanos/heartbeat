...
<%@ page import="heartbeat.AssetType" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="assets"><g:message code="assetType.assets.label" default="Assets" /></label>
                                </td>
...
<g:link controller="asset" action="create" params="['assetType.id': assetTypeInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'asset.label', default: 'Asset')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="assetType.name.label" default="Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: assetTypeInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${assetTypeInstance?.name}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="user"><g:message code="assetType.user.label" default="User" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: assetTypeInstance, field: 'user', 'errors')}">
                                    <g:select name="user.id" from="${heartbeat.User.list()}" optionKey="id" value="${assetTypeInstance?.user?.id}"  />
                                </td>
                            </tr>
