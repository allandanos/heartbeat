            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="assetType.assets.label" default="Assets" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="assetType.user.label" default="User" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${assetTypeInstance?.user?.id}">${assetTypeInstance?.user?.encodeAsHTML()}</g:link></td>
